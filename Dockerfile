...
# Build like this:
# docker build  -t AlphaSolutions-Exam

# Run like this:
# docker run -it --rm --name AlphaSolutions-Exam. --pid=host -p 8080:8080 -e MYSQL_ROOT_PASSWORD=${MYSQL_ROOT_PASSWORD} AlphaSolutions-Exam.
#
